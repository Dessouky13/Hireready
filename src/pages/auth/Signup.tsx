...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const discountMsg = promoData ? ` You get ${promoData.discount_percent}% discount!` : "";
    toast.success(`Account created!${discountMsg}`);
    // Go to onboarding before dashboard
    navigate("/onboarding");
  };
    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <div className="neo-card w-full max-w-md bg-card p-8">
        ...
        <button
          ...
          className="neo-btn mb-6 flex w-full items-center justify-center gap-3 bg-background text-foreground"
        >
          <GoogleIcon />
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center">
            <span className="bg-card px-3 font-heading text-xs uppercase text-muted-foreground">or</span>
          </div>
        </div>
